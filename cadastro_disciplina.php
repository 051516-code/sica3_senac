...
<body>
    ...
    <nav class="navbar bg-light">
      ...
      <div class="container">
        ...
        <div class="col-md-12">
          <p class="text-center">Preencher dados da disciplina:</p>
          <fieldset>

        <legend class="text-center">Cadastro de Disciplina</legend>

          <form action="manter/manter_disciplina.php" method="post">
          ...
          <div class="form-group">
              ...
              <label for="floatingTextarea">Ementa:</label>
              <div class="form-floating">
                      <textarea class="form-control" id="ementa" name="ementa"></textarea>
              </div>
          </div>
