...
<head>
    ...
    <title>Cadastro de Disciplina em Curso</title>
</head>
<body>
    <style>
    ...
    <nav class="navbar bg-light">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <legend class="text-center">Cadastro de disciplina nos cursos</legend>

          <form action="manter/manter_disciplina_curso.php" method="post">

              <div class="form-group">
                  <label for="id_aluno">Selecione o curso:</label>
              ...
              <div class="form-group">
                  <label for="id_professor">Selecione a disciplina:</label>
