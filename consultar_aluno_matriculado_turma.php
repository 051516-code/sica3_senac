...
<head>
    ...
    <title>Consulta de alunos matriculados em turma</title>
</head>
<body>
    <style>
    ...
    <nav class="navbar bg-light">
      ...
      <div class="col-md-12">
        ...
        <legend class="text-center">Consulta de alunos matriculados em turma</legend>

            <form action="" method="post">
                <div class="form-group">
                    <label for="id_aluno">Selecione a disciplina:</label>
