...
<body>
    ...
    <nav class="navbar bg-light">
      ...
      <legend class="text-center">Cadastro de Turma</legend>

          <form action="manter/manter_turma.php" method="post">

                            

          <div class="form-group">
              <label for="id_disciplina">Selecione o Disciplina:</label>
               <select class="form-select" aria-label="Default select example" id="id_disciplina" name="id_disciplina">
                  <option selected>Selecione...</option>
                  <?php 
                  require('manter/conexao.php');

                  $consulta = "SELECT `id_disciplina`, `nome` FROM `disciplina`";
          ...
          <div class="form-group">
              ...
              <select class="form-select" aria-label="Default select example" id="id_professor" name="id_professor">
                  <option selected>Selecione...</option>
                  <?php 
                  require('manter/conexao.php');

                  $consulta = "SELECT `cpf`, `nome` FROM `professor`";
                  $sql = mysqli_query($conexao,$consulta);
                  while ($linha = mysqli_fetch_array($sql)) {
